...
DOCUMENTATION = """
---
module: fwebos_waf_file_upload_policy_rule
short_description: Assign FortiWeb Input Validation File Security rules to policy
description:
...
obj_url = '/api/v2.0/cmdb/waf/file-upload-restriction-policy/rule'
...
def add_obj(module, connection):
    ...
    file_upload_restriction_rule = module.params['file_upload_restriction_rule']

    payload = {
        'data':
        {
            'file-upload-restriction-rule': file_upload_restriction_rule,
        },
    }
...
def needs_update(module, data):
    res = False
    if module.params['file_upload_restriction_rule'] and module.params['file_upload_restriction_rule'] != data['file-upload-restriction-rule']:
        data['file-upload-restriction-rule'] = module.params['file_upload_restriction_rule']
        res = True
...
def main():
    argument_spec = dict(
        ...
        name=dict(type='str'),
        file_upload_restriction_rule=dict(type='str'),
