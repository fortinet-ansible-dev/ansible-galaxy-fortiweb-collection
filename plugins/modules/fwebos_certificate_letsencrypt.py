...
DOCUMENTATION = """
---
module: fwebos_certificate_letsencrypt
short_description: Config FortiWeb server objects Letsencrypt
description:
...
options:
    ...
    domain:
        description:
            - domain of this certificate
        type: string
    expire-date:
        description:
            - expire date of this certificate
        type: string
    renew-period:
        description:
            - number of days to renew certificate before it is expired, 30 days by default 
        type: integer
"""
...
obj_url = '/api/v2.0/cmdb/system/certificate.letsencrypt'
