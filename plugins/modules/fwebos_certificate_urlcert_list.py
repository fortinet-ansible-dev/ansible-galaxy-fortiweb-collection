...
DOCUMENTATION = """
---
module: fwebos_certificate_urlcert_list
short_description: Config FortiWeb server objects URL Certificate list
description:
...
obj_url = '/api/v2.0/cmdb/system/certificate.urlcert/list'
