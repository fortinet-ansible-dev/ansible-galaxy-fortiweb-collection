...
options:
    name:
        description:
            - The name of waiting room policy.
        type: string
    id:
        description:
            - The numerical ID of bypass rule.
        type: string
    value:
        description:
...
obj_url = '/api/v2.0/cmdb/waf/waiting-room-policy/bypass-rules'
...
def main():
    ...
    if 'errcode' in str(result):
        ...
        if result['res']['results']['errcode'] == -1 or result['res']['results']['errcode'] == -3 or result['res']['results']['errcode'] == -5 or result['res']['results']['errcode'] == -6014:
            result['failed'] = False
