...
DOCUMENTATION = """
---
module: fwebos_waf_json_schema_group
short_description: Config FortiWeb JSON Schema Group
description:
...
obj_url = '/api/v2.0/cmdb/waf/json-schema.group'
...
def main():
    ...
    # if action == 'add' and data['results'] is not None:
    #     result['res'] = "A duplicate entry has already existed."
    #     result['changed'] = False
    # else:
    #     result = check_mode_process(module, data, rep_dict)
