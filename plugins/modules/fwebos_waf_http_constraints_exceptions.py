...
DOCUMENTATION = """
---
module: fwebos_waf_http_constraints_exceptions
short_description: Config FortiWeb Web Protection HTTP Constraints exceptions
description:
...
options:
    name:
        description:
            - http constrains exception name
        type: string
"""
...
obj_url = '/api/v2.0/cmdb/waf/http-constraints-exceptions'
