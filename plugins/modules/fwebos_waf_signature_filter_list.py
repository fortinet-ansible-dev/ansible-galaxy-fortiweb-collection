...
short_description: Config FortiWeb Web Protection Signature filter list
description:
...
rep_dict = {
    ...
    'concatenate_type': 'concatenate-type',
...
def main():
    argument_spec = dict(
        ...
        id=dict(type='str'),
        match_target=dict(type='str'),
        operator=dict(type='str'),
        value_check=dict(type='str'),
        concatenate_type=dict(type='str'),
