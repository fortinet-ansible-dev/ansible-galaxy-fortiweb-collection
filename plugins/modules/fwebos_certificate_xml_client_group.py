...
DOCUMENTATION = """
---
module: fwebos_certificate_xml_client_group
short_description: Config FortiWeb server objects XML Certificate Client group
description:
...
obj_url = '/api/v2.0/cmdb/system/certificate.xml-client-certificate-group'
