...
DOCUMENTATION = """
---
module: fwebos_waf_http_header_security_policy_exception
short_description: Config FortiWeb HTTP Header Security Policy Exception
description:
...
obj_url = '/api/v2.0/cmdb/waf/http-header-security-exception'
