...
---
module: fwebos_admin
short_description: Configure FortiWeb admin
description:
...
def main():
    argument_spec = dict(
        ...
        name=dict(type='str'),
        access_profile=dict(type='str'),
        trusthostv4=dict(type='str'),
        trusthostv6=dict(type='str'),
        domains=dict(type='str'),
        type=dict(type='str'),
        admin_usergrp=dict(type='str'),
        force_password_change=dict(type='str'),
    ...
    if not param_pass:
        ...
        if 'errcode' in str(data):
            ...
            if res:
                ...
                code, response, senddata = edit_obj(module, new_data1, connection)
                result['res'] = response
                result['changed'] = True
