...
DOCUMENTATION = """
---
module: fwebos_waf_site_publish_rule_custom_header
short_description: Config Custom Headers in a Site Publish Rule
description:
...
options:
    name:
        description:
            - The name of published site rule
        type: string
    id:
        description:
            - The index of the custom header of the published site rule.
        type: string
    custom_header_name:
        description:
            - Custom Header Name.
        type: string
    custom_header_value_format:
        description:
...
obj_url = '/api/v2.0/cmdb/waf/site-publish-helper.rule/custom-headers'


rep_dict = {
    "custom_header_name": "custom-header-name",
    "custom_header_value_format": "custom-header-value-format"
}
...
def main():
    argument_spec = dict(
        ...
        vdom=dict(type='str'),
        id=dict(type='str'),
        custom_header_name=dict(type='str'),
        custom_header_value_format=dict(type='str'),
    )
