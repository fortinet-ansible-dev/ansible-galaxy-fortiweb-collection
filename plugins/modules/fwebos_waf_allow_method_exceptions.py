...
DOCUMENTATION = """
---
module: fwebos_waf_allow_method_exceptions
short_description: Config FortiWeb Web Protection Allow Method Exceptions
description:
  - Config FortiWeb Web Protection Allow Method Exceptions
version_added: "7.0.0"
author:
  - Joseph Chen
requirements:
...
EXAMPLES = """
    - name: add an allow method exceptions object
      fwebos_waf_allow_method_exceptions:
       action: add
       name: allow_method_exception_1

    - name: delete an allow method exceptions object
      fwebos_waf_allow_method_exceptions:
       action: delete
       name: allow_method_exception_1

    - name: get an allow method exceptions object
      fwebos_waf_allow_method_exceptions:
       action: get
       name: allow_method_exception_1
"""
...
obj_url = '/api/v2.0/cmdb/waf/allow-method-exceptions'
