...
short_description: Config FortiWeb CSRF Protection Rule
description:
...
options:
    ...
    block_period:
        description:
            - Enter the number of seconds that you want to block subsequent requests from the client after the FortiWeb appliance detects a CSRF attack. This setting is available only if 'security_action' is set to 'block-period'. 
        type: integer
    severity:
        description:
...
rep_dict = {
  ...
  "js_request_check": "js-request-check", 
...
def main():
    argument_spec = dict(
        ...
        js_request_check=dict(type='str'), 
        vdom=dict(type='str'),
