...
short_description: Config FortiWeb URL Rules in a Rewriting Policy
description:
...
def main():
    ...
    if 'errcode' in str(result):
        ...
        if result['res']['results']['errcode'] == -3 or result['res']['results']['errcode'] == -5 or result['res']['results']['errcode'] == -548:
            result['failed'] = False
