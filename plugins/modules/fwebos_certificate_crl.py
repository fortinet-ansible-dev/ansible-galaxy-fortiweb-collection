...
obj_url = '/api/v2.0/system/certificate.crl'
del_url = '/api/v2.0/cmdb/system/certificate.crl'
...
def add_obj_crl(module, connection):
    payload1 = {}
...
def main():
    argument_spec = dict(
        ...
        name=dict(type='str'),
        type=dict(type='str'),
        httpUrl=dict(type='str'),
        scepUrl=dict(type='str'),
