...
DOCUMENTATION = """
---
module: fwebos_certificate_local_multi
short_description: Config FortiWeb server objects Local Multi-certificate
description:
...
options:
    ...
    comment:
        description:
            - comment of this multi certificate
        type: string
"""
...
obj_url = '/api/v2.0/cmdb/system/certificate.multi-local'
...
def main():
    argument_spec = dict(
        ...
        vdom=dict(type='str'),
        name=dict(type='str'),
        rsa_cert=dict(type='str'),
        dsa_cert=dict(type='str'),
        ecc_cert=dict(type='str'),
