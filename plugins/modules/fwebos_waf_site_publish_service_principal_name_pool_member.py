...
DOCUMENTATION = """
---
module: fwebos_waf_site_publish_service_principal_name_pool_member
short_description: Config FortiWeb Published Site Policy's Service Principal Name Pool's Members
description:
...
options:
    name:
        description:
            - The name of the Published Site Policy's Service Principal Name Pool.
        type: string
    id:
        description:
            - The numerical ID of Service Principal Name Pool's member.
        type: string
    server:
        description:
            - The IP/Domain of the SNP.
        type: string
...
obj_url = '/api/v2.0/cmdb/waf/site-publish-helper.service-principal-name-pool/members'
