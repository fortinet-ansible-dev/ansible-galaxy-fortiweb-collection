...
DOCUMENTATION = """
---
module: fwebos_waf_url_access_policy
short_description: Config FortiWeb Web Protection URL Access policy
description:
...
obj_url = '/api/v2.0/cmdb/waf/url-access.url-access-policy'
