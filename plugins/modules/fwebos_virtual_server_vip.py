...
short_description: Assign FortiWeb virtual IP with virtual server
description:
...
def add_obj(module, connection):
    ...
    use_interface_ip = module.params['use_interface_ip']
...
def needs_update(module, data):
    ...
    if module.params['status'] and module.params['status'] != data['status']:
        ...
        res = True
    if module.params['use_interface_ip'] and module.params['use_interface_ip'] != data['use-interface-ip']:
        data['use-interface-ip'] = module.params['use_interface_ip']
        res = True
...
def main():
    argument_spec = dict(
        ...
        use_interface_ip=dict(type='str', default='disable'),
        vip=dict(type='str'),
