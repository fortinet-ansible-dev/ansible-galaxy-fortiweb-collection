...
short_description: Config FortiWeb server objects Server Pool member
description:
...
def main():
    ...
    if 'errcode' in str(result):
        ...
        if result['res']['results']['errcode'] == -3 or result['res']['results']['errcode'] == -5 or result['res']['results']['errcode'] == -37:
            result['failed'] = False
