...
DOCUMENTATION = """
---
module: fwebos_waf_site_publish_policy_rule
short_description: Config rule entries in a Site Publish Policy
description:
...
options:
    name:
        description:
            - The name of published site policy.
        type: string
    id:
        description:
            - The ID of the rule entry.
        type: string
    rule_name:
        description:
...
obj_url = '/api/v2.0/cmdb/waf/site-publish-helper.policy/rule'
