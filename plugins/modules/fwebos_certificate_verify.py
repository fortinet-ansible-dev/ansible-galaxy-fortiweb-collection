...
DOCUMENTATION = """
---
module: fwebos_certificate_verify
short_description: Config FortiWeb server objects Certificate Verify
description:
...
options:
    ...
    publish-dn:
        description:
            - disable/enable CA DistinguishedName publish
        type: string
        choices:
            - 'enable'
            - 'disable'
    strictly-need-cert:
        description:
            - disable/enable strictly need client cert
        type: string
        choices:
            - 'enable'
            - 'disable'
    partial-chain:
        description:
            - disable/enable partial chain client certificate verification
        type: string
        choices:
            - 'enable'
            - 'disable'
...
obj_url = '/api/v2.0/cmdb/system/certificate.verify'

rep_dict = {
    'publish_dn': 'publish-dn',
    'strictly_need_cert': 'strictly-need-cert',
}
...
def main():
    argument_spec = dict(
        ...
        vdom=dict(type='str'),
        name=dict(type='str'),
        publish_dn=dict(type='str'),
        strictly_need_cert=dict(type='str'),
        ca=dict(type='str'),
        crl=dict(type='str'),
    )
