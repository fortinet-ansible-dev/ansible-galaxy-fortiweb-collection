...
DOCUMENTATION = """
---
module: fwebos_certificate_offline_sni_group
short_description: Config FortiWeb server objects SNI Offline SNI
description:
...
obj_url = '/api/v2.0/cmdb/system/certificate.offline-sni'
