...
short_description: Config FortiWeb IP Protection IP List
description:
...
def add_obj(module, connection):
    ...
    trigger_policy = module.params['trigger_policy']
...
def needs_update(module, data):
    ...
    if module.params['ignore_x_forwarded_for'] and module.params['ignore_x_forwarded_for'] != data['ignore-x-forwarded-for']:
        ...
        res = True
    if module.params['trigger_policy'] and module.params['trigger_policy'] != data['trigger-policy']:
        data['trigger-policy'] = module.params['trigger_policy']
        res = True
...
def main():
    argument_spec = dict(
        ...
        trigger_policy=dict(type='str', default=''),
        vdom=dict(type='str'),
    )
