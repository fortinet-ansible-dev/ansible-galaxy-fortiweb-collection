...
short_description: Config FortiWeb DoS Exception Policy
description:
  - Config FortiWeb DoS Exception Policy
version_added: "7.0.0"
author:
  - Joseph Chen
requirements:
...
EXAMPLES = """
    - name: add a DoS exception policy
      fwebos_waf_dos_exception_policy:
       action: add
...
obj_url = '/api/v2.0/cmdb/waf/dos-prevention-exception'
