...
DOCUMENTATION = """
---
module: fwebos_certificate_intermediate_ca_group
short_description: Config FortiWeb server objects Intermediate CA group
description:
...
obj_url = '/api/v2.0/cmdb/system/certificate.intermediate-certificate-group'
