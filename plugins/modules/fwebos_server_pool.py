...
def add_obj(module, connection):
    ...
    server_balance = module.params['server_balance']
    server_type = module.params['server_type']
    health = module.params['health']
    persistence = module.params['persistence']
    lb_algo = module.params['lb_algo']

    payload = {
        'data':
        {
            'name': name,
            'server-balance': server_balance,
            'type': server_type,
            'health': health,
...
def needs_update(module, data):
    ...
    if module.params['persistence'] and module.params['persistence'] != data['persistence']:
        ...
        res = True
    if module.params['health'] and module.params['health'] != data['health']:
        data['health'] = module.params['health']
        res = True
    if module.params['server_balance'] and module.params['server_balance'] != data['server-balance']:
        data['server-balance'] = module.params['server_balance']
        res = True
    if module.params['server_type'] and module.params['server_type'] != data['type']:
        data['type'] = module.params['server_type']
        res = True
    if module.params['lb_algo'] and module.params['lb_algo'] != data['lb-algo']:
        data['lb-algo'] = module.params['lb_algo']
        res = True
...
def main():
    argument_spec = dict(
        ...
        server_balance=dict(type='str', default='disable'),
        server_type=dict(type='str', default='reverse-proxy'),
