...
DOCUMENTATION = """
---
module: fwebos_waf_custom_protection_group_type_list
short_description: Assign FortiWeb Custom Policy Custom Rule to policy
description:
...
obj_url = '/api/v2.0/cmdb/waf/custom-protection-group/type-list'
...
def add_obj(module, connection):
    ...
    custom_protection_rule = module.params['custom_protection_rule']

    payload = {
        'data':
        {
            'custom-protection-rule': custom_protection_rule,
        },
    }
...
def needs_update(module, data):
    ...
    if module.params['custom_protection_rule'] and module.params['custom_protection_rule'] != data['custom-protection-rule']:
        data['custom-protection-rule'] = module.params['custom_protection_rule']
        res = True
...
def main():
    argument_spec = dict(
        ...
        name=dict(type='str'),
        custom_protection_rule=dict(type='str'),
        vdom=dict(type='str'),
