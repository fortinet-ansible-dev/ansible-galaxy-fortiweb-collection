...
def needs_update(module, data):
    ...
    if module.params['rule_type'] and module.params['rule_type'] != data['rule_type']:
        data['rule_type'] = module.params['rule_type']
        res = True
    if module.params['rule_action'] and module.params['rule_action'] != data['action']:
        data['action'] = module.params['rule_action']
        res = True
...
def main():
    argument_spec = dict(
        ...
        name=dict(type='str'),
        rule_type=dict(type='str', default='request'),
        rule_action=dict(type='str', default='alert'),
