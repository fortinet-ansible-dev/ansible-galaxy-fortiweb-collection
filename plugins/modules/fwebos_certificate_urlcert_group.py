...
DOCUMENTATION = """
---
module: fwebos_certificate_urlcert_group
short_description: Config FortiWeb server objects URL Certificate group
description:
...
options:
    name:
        description:
            - URL base client certificate group name
        type: string
"""
...
obj_url = '/api/v2.0/cmdb/system/certificate.urlcert'
