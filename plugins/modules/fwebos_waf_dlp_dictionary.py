...
DOCUMENTATION = """
---
module: fwebos_waf_dlp_dictionary
short_description: Config FortiWeb Data Loss Preventation Dictionary
description:
...
obj_url = '/api/v2.0/cmdb/waf/dlp.dictionary'
...
def param_check(module, connection):
    ...
    if (action == 'add' or action == 'edit' or action == 'delete') and module.params['name'] is None:
        ...
        res = False
    res, err_msg = value_check(module.params, 'match_type', ['all', 'any'])
    if res == False:
        return res, err_msg
    return res, err_msg
