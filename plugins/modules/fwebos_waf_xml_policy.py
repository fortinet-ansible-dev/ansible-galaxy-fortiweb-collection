...
def add_obj(module, connection):
    ...
    enable_signature_detection = module.params['enable_signature_detection']

    payload = {
        'data':
        {
            'name': name,
            'enable-signature-detection': enable_signature_detection,
...
def needs_update(module, data):
    ...
    if module.params['enable_signature_detection'] and module.params['enable_signature_detection'] != data['enable-signature-detection']:
        data['enable-signature-detection'] = module.params['enable_signature_detection']
        res = True
...
def main():
    argument_spec = dict(
        ...
        name=dict(type='str'),
        enable_signature_detection=dict(type='str'),
        vdom=dict(type='str'),
    )
