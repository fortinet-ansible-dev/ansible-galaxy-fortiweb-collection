...
DOCUMENTATION = """
---
module: fwebos_certificate_letsencrypt_issue
short_description: Call FortiWeb server objects Letsencrypt issue action
description:
...
obj_url = '/api/v2.0/system/certificate.letsencrypt.issue'
...
def issue_obj(module, connection):
...
def param_check(module, connection):
    ...
    if (action == 'issue' or action == 'edit' or action == 'delete') and module.params['name'] is None:
...
def main():
    ...
    if not param_pass:
        ...
        code, response = issue_obj(module, connection)
        result['res'] = response
        result['changed'] = True
    else:
